...
# Save predictions for Go validation runner
predictions_df = pd.DataFrame({
    "prediction": python_pred
})

predictions_df.to_csv(RESULTS_DIR / "python_predictions.csv", index=False)

print(f"Predictions saved to {RESULTS_DIR / 'python_predictions.csv'}")